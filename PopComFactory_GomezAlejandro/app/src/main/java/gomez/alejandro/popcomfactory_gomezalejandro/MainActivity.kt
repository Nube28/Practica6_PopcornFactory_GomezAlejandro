...
class PeliculaAdapter: BaseAdapter{
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup?): View {
        ...
        val ivImagenPelicula = vista.findViewById(R.id.iv_pelicula) as ImageView
        val tvNombrePelicula = vista.findViewById(R.id.tv_titulo) as TextView
        ...
        ivImagenPelicula.setOnClickListener{
            ...
            intent.putExtra("numberSeats", pelicula.seats.size)
